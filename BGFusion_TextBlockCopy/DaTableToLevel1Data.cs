...
{
   public  class DaTableToLevel1Data:BaseTableConvert
    {
        private DataTable TemplatTable;
        public DaTableToLevel1Data(DaTableConverParameter  ConverParameter,  DataTable templateTable )
        {
        ...
        public override string sOutData()
        {
            ...
            try
            {
                var ELementLineGroups = from p in MainRows
                                        group p by 
                                        new
                                        { system = p.Field<string>(baseTableConverParameter.TaglistColName[1, 0]),
                                            plc = p.Field<string>(baseTableConverParameter.TaglistColName[1, 1]),
                                            line = p.Field<string>(baseTableConverParameter.TaglistColName[1, 3]),
                                            view = p.Field<string>(baseTableConverParameter.TaglistColName[1, 16]),
                                            draw = p.Field<string>(baseTableConverParameter.TaglistColName[1, 17])
                                        } 
                                        into pp
                                        select pp;
